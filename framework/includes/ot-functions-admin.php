...
if ( ! function_exists( 'ot_admin_styles' ) ) {
  ...
  function ot_admin_styles() {
    ...
    /* load vendor styles
    wp_enqueue_style( 'bootstrap-css', 'http://netdna.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.css', false, '3.3.5' );
    ...
    wp_enqueue_style( 'ot-custom-css', OT_URL . 'assets/css/ot-custom.css', false, OT_VERSION );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    /* load summernote editor for HTML Editing
    wp_enqueue_script( 'bootstrap-js', 'http://netdna.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.js', array('jquery'), '3.3.5' );
